...
class InitiateTransferDialog(QtGui.QDialog):
    ...
    def transfer(self):
        ...
        server_id = str(self.server_combo.getOTID())
        from_id = str(self.account_combo.getOTID())
        to_id = str(self.recipient_edit.text())
        ...
        note = str(self.memo_edit.toPlainText())
...
class ChequeCreateDialog(QtGui.QDialog):
    ...
    def createCheque(self):
        ...
        amount = str(self.amount_spin.value())
        valid_from, valid_to = "", ""
        account_id = str(self.account_combo.getOTID())
        nym_id = otapi.OTAPI_Basic_GetAccountWallet_NymID(account_id)
        memo = str(self.memo_edit.toPlainText())
        recipient = str(self.recipient_edit.text())
