...
class EditWidget(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.servers_model = dojima.model.ot.servers.OTServersTreeModel()
        self.assets_model = dojima.model.ot.assets.OTAssetsSettingsModel()
...
class AssetMappingDialog(QtGui.QDialog):
    ...
    def __init__(self, assetId, parent=None):
        ...
        self.contract = dojima.ot.contract.CurrencyContract(self.asset_id)
        ...
        # select
        self.model = dojima.model.ot.assets.OTAssetsSettingsModel()
