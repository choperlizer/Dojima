...
class VirwoxProviderItem(dojima.model.exchanges.DynamicExchangeItem):
...
class VirwoxAccount(_Virwox, dojima.exchange.ExchangeAccount):
...
dojima.exchange.register_exchange(VirwoxExchangeMarket)
dojima.exchange.register_account(VirwoxAccount)
dojima.exchange.register_exchange_model_item(VirwoxProviderItem)
