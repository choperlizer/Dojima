...
class Wizard(QtGui.QWizard):
    ...
    def __init__(self, parent=None):
        ...
        for title, widget in (("commodities",
    ...
    def create_intro_page(self):
        page = QtGui.QWizardPage()
        page.setTitle("inital markets and exchanges definition")
        label = QtGui.QLabel(
            QtCore.QCoreApplication.translate(
                "First page of the wizard",
                """Tulpenmanie was conceived to be a customizable and """
                """extensible commodity exchange client. As such, it comes """
                """without any predefined commodities. First you must create """
                """at least two commodities, at least one market, map a local """
                """market to a remote one, and if you desire to trade, enter """
